...
AUTOPILOT_ROOT := /media/he/c6c60fc3-65e5-407b-86ac-16ca6e42848f/he/Vitis_HLS/2023.2
...
IFLAG += -fPIC
ifndef AP_GCC_PATH
  AP_GCC_PATH := /media/he/c6c60fc3-65e5-407b-86ac-16ca6e42848f/he/Vitis_HLS/2023.2/tps/lnx64/gcc-8.3.0/bin
endif
...
$(ObjDir)/nms_impl_tb.cpp_pre.cpp.tb.o : nms_impl_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling nms_impl_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/nms_impl.cpp_pre.cpp.tb.o : nms_impl.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling nms_impl.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
