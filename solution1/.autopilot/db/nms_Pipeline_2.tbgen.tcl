...
set C_modelName {nms_Pipeline_2}
...
set portList { 
	...
	{ iou_matrix_address0 sc_out sc_lv 13 signal 0 } 
	{ iou_matrix_ce0 sc_out sc_logic 1 signal 0 } 
	{ iou_matrix_we0 sc_out sc_logic 1 signal 0 } 
	{ iou_matrix_d0 sc_out sc_lv 32 signal 0 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "4952", "EstimateLatencyMax" : "4952",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set ArgLastReadFirstWriteLatency {
	nms_Pipeline_2 {
		iou_matrix {Type O LastRead -1 FirstWrite 0}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4952", "Max" : "4952"}
	, {"Name" : "Interval", "Min" : "4952", "Max" : "4952"}
]}
